(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.grace, 500, 100, 8, 0,20);
        collectable.create(type.max, 100, 50, 30, 0,15);
        collectable.create(type.kennedi, 400, 32,6,0,19);
        collectable.create(type.db, 700,50,30,0,10);
